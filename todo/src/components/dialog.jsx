...
function Dialog({  isOpen = false,  closeModal,  children,  createClick, title = '',}) {
  ...
  return createPortal(
    <div onClick={closeModal} className={`fixed p-4  z-[10px] top-0 left-0 h-full w-full flex items-center justify-center  bg-[#6B6B6B] bg-opacity-50 `}>
      <div  onClick={(e) => e.stopPropagation()} className={` !bg-[#ffffff] z-[20px] max-h-[calc(100vh-50px)] relative w-[400px] py-6 px-2 rounded-lg shadow-lg`} >
       ...
       <div onClick={closeModal}>
        ...
        <div className="p-4 overflow-y-auto h-full no-scrollbar dark-scrollbar ">
